...
export function Header() {
  ...
  const navLinks = [
    { href: "/", label: "General" },
    { href: "/crypto", label: "Crypto Residency" },
    { href: "/art", label: "Art Residency" },
    { href: "/longevity", label: "Longevity Residency" },
  ]
    ...
    <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-md border-b border-border">
      <div className="w-full px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
        <a href="https://www.4seas.xyz/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
          <img src={withBasePath("/images/4seas-logo.png")} alt="4Seas" className="h-6 md:h-8 w-auto" />
        </a>
